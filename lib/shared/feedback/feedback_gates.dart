...
final Provider<bool> hapticsEnabledProvider = Provider<bool>(
  (ref) => ref.watch(
    appSettingsProvider.select((settings) => settings.isHapticsEnabled),
  ),
);
...
final Provider<bool> soundEnabledProvider = Provider<bool>(
  (ref) => ref.watch(
    appSettingsProvider.select((settings) => settings.isSoundEnabled),
  ),
);
...
final Provider<bool> reduceMotionEnabledProvider = Provider<bool>(
  (ref) => ref.watch(
    appSettingsProvider.select((settings) => settings.isReduceMotionEnabled),
  ),
);
