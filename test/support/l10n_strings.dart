...
Map<String, String> renderAllStrings(AppLocalizations l10n) {
  ...
  return <String, String>{
    ...
    'foundOfTotal': l10n.foundOfTotal(n(6), n(25)),
    ...
    'durationHoursMinutes': l10n.durationHoursMinutes(n(3), n(12)),
...
const Map<String, TypeSlot> kTypeSlots = <String, TypeSlot>{
  ...
  'gameSchulteGridKicker': (step: 'label', lines: 2),
  'schulteMissesLabel': (step: 'label', lines: 2),
  'schulteTilesLabel': (step: 'label', lines: 2),
